...
<section>
    <div class="busy">
        <div class="busytxt"><span>OJ最繁忙的一天是</span><span>00</span>月<span>00</span>日</div>
        <div class="zyt">这一天发生了什么...</div>
        <div class="cartoon">
            <div class="ctface">
                <div class="cteyes">
                    <div class="eye"></div>
...
onMounted(()=>{
    const busyanim = new IntersectionObserver((entries)=>{
